...
class Food:
    ...
    def __init__(self, screen, snake, delay=80):
        self.delay = delay
        self.snake = snake
        self.screen = screen
...
class Score:
    ...
    def __init__(self, screen, highscore, score=0):
        self.score = score
    ...
    def update(self, color):
        ...
        self.label_highscoreText = self.font.render("Highscore:", True, color)
        self.label_score = self.font.render(str(self.score), True, color)
        self.label_highscore = self.font.render(str(self.highscore), True, color)
        self.screen.blit(self.label_scoreText, (20, 10))
        self.screen.blit(self.label_score, (90, 10))
        self.screen.blit(self.label_highscoreText, (width-200, 10))
        self.screen.blit(self.label_highscore, (width-100, 10))
        
class Part:
    """ this class is responsible for adding a part to the snake """
    
    def __init__(self, snakeImage, x=0, y=0, direction=right):
        self.direction = direction
        self.image = pygame.image.load(snakeImage).convert()
...
class Snake:
    ...
    def __init__(self, screen, x=320, y=240, direction = right):
        self.screen = screen
        self.head = Part("images/part.bmp", x,y)
        self.direction = direction
        self.parts = []
    ...
    def move(self, food, score):
        ...
        if self.extend_snake:
            ...
            new_part = Part("images/part.bmp", last_part.position.x, last_part.position.y, last_part.direction)
